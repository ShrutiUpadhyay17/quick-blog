        ...
        <div className="flex-1 pt-5 px-5 sm:pt-12 sm:pl-16 bg-blue-50/50">
            <div className="flex justify-between items-center max-w-3xl">
                ...
                <div className="flex gap-4">
                    ...
                    className={`shadow-custom-sm border rounded-full 
                        px-4 py-1 cursor-pointer text-xs 
            ...
            <div className="relative h-4/5 max-w-3xl overflow-x-auto 
            mt-4 bg-white shadow rounded-lg scrollbar-hide">
